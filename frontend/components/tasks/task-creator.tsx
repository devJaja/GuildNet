    ...
    <div className="glass-card p-8 space-y-6">
      ...
      {onChainTx && (
        <div className="flex items-center gap-2 text-xs text-zinc-400">
          ...
          <a href={`https://sepolia.basescan.org/tx/${onChainTx}`} target="_blank" rel="noreferrer" className="text-cyan-400 hover:underline font-mono">{onChainTx.slice(0, 18)}…</a>
        </div>
      )}
      ...
      {step === "done" && result && (
        <div className="space-y-3">
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <a href={`https://sepolia.basescan.org/tx/${result.txHashes[0]}`} target="_blank" rel="noreferrer" className="text-xs text-cyan-400 hover:underline">Basescan →</a>
          </div>
